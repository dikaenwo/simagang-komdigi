...
class UsersController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				users.role LIKE ? OR 
				users.nim LIKE ? OR 
				users.jurusan LIKE ? OR 
				users.institutisi LIKE ? OR 
				users.tanggal_masuk LIKE ? OR 
				users.tanggal_keluar LIKE ? OR 
				users.status LIKE ? OR 
				users.jenjang_pendidikan LIKE ? OR 
				users.jenis_kelamin LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("name","email","password","photo","nim","jurusan","institutisi","tanggal_masuk","tanggal_keluar","jenjang_pendidikan","jenis_kelamin");

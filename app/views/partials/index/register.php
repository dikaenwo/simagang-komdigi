                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="jenjang_pendidikan">Jenjang Pendidikan <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <select required=""  id="ctrl-jenjang_pendidikan" name="jenjang_pendidikan"  placeholder="Select a value ..."    class="custom-select" >
                                                            <option value="">Select a value ...</option>
                                                            <?php
                                                            $jenjang_pendidikan_options = Menu :: $jenjang_pendidikan;
                                                            if(!empty($jenjang_pendidikan_options)){
                                                            foreach($jenjang_pendidikan_options as $option){
                                                            $value = $option['value'];
                                                            $label = $option['label'];
                                                            $selected = $this->set_field_selected('jenjang_pendidikan', $value, "");
                                                            ?>
                                                            <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                                <?php echo $label ?>
                                                            </option>                                   
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-jurusan"  value="<?php  echo $this->set_field_value('jurusan',""); ?>" type="text" placeholder="Enter Jurusan"  required="" name="jurusan"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="nim">NIM/NIS <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-nim"  value="<?php  echo $this->set_field_value('nim',""); ?>" type="text" placeholder="Enter NIM/NIS"  required="" name="nim"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <label class="control-label" for="institutisi">Institutisi <span class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-institutisi"  value="<?php  echo $this->set_field_value('institutisi',""); ?>" type="text" placeholder="Enter Institutisi"  required="" name="institutisi"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

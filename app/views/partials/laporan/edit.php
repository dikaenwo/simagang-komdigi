                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <div class="dropzone required" input="#ctrl-file_laporan" fieldname="file_laporan"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                        <input name="file_laporan" id="ctrl-file_laporan" required="" class="dropzone-input form-control" value="<?php  echo $data['file_laporan']; ?>" type="text"  />
                                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                            <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                        </div>
                                                    </div>
                                                    <?php Html :: uploaded_files_list($data['file_laporan'], '#ctrl-file_laporan'); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

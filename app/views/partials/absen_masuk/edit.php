            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate id="absen-pulang-form" role="form" enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("absen_masuk/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-jam_pulang" class="form-control" required readonly value="<?php echo date('Y-m-d H:i:s'); ?>" type="text" name="jam_pulang" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="bukti_foto_pulang">Bukti Foto Pulang <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="text-center">
                                                ...
                                                <input type="hidden" name="bukti_foto_pulang" id="ctrl-bukti_foto_pulang" required />
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const buktiInput = document.getElementById('ctrl-bukti_foto_pulang');
    ...
    // Form validation
    document.getElementById('absen-pulang-form').addEventListener('submit', function(e) {
        if (!buktiInput.value) {
            e.preventDefault();

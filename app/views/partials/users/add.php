                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-nim"  value="<?php  echo $this->set_field_value('nim',""); ?>" type="text" placeholder="Enter Nim"  required="" name="nim"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <input id="ctrl-jenjang_pendidikan"  value="<?php  echo $this->set_field_value('jenjang_pendidikan',""); ?>" type="text" placeholder="Enter Jenjang Pendidikan"  required="" name="jenjang_pendidikan"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>

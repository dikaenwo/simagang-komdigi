                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-nim"  value="<?php  echo $data['nim']; ?>" type="text" placeholder="Enter Nim"  required="" name="nim"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-jurusan"  value="<?php  echo $data['jurusan']; ?>" type="text" placeholder="Enter Jurusan"  required="" name="jurusan"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-institutisi"  value="<?php  echo $data['institutisi']; ?>" type="text" placeholder="Enter Institutisi"  required="" name="institutisi"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-jenjang_pendidikan"  value="<?php  echo $data['jenjang_pendidikan']; ?>" type="text" placeholder="Enter Jenjang Pendidikan"  required="" name="jenjang_pendidikan"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>

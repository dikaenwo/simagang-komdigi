                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-jurusan"> Jurusan</th>
                                                <th  class="td-institutisi"> Institutisi</th>
                                                <th  class="td-tanggal_masuk"> Tanggal Masuk</th>
                                                <th  class="td-tanggal_keluar"> Tanggal Keluar</th>
                                                <th  class="td-status"> Status</th>
                                                <th  class="td-jenjang_pendidikan"> Jenjang Pendidikan</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-jenjang_pendidikan">
